...
--teacher_model_save_dir out/bert_teacher_gridsearch/final_hd020_ad030_cd020/model  --version_identifier e2_bbcloss \
 --learning_rate 0.00002 --batch_size 32 --epochs 2 --max_length 48 \
