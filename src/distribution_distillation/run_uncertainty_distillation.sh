...
--teacher_model_save_dir out/bert_teacher/final_hd020_ad030_cd020/model --version_identifier e2 \
 --learning_rate 0.00002 --batch_size 256 --epochs 2 --max_length 48 --m 5 --k 10 --output_dir out/bert_student
