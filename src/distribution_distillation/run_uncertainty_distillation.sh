...
--teacher_model_save_dir out/bert_teacher/final_hd030_ad020_cd035/model --version_identifier e2_dropout010--save_predictive_distributions --learning_rate 0.00002 --batch_size 32 \
--epochs 2 --max_length 48 --output_dir out/bert_student --m 5 --k 5 --final_layer_dropout_rate 0.1 --seed 42
