#!/bin/bash
#SBATCH --job-name=rtuq-augment-student-gridsearch
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a10080gb:3
#SBATCH --mem=32G
#SBATCH --output=shen-student-augmentation-gridsearch_%j.out
...
for shen_loss_weight in "${shen_loss_weights[@]}"; do
    for learning_rate in "${learning_rates[@]}"; do
        for epochs in "${epochs_list[@]}"; do
            ...
            python3.8 src/experiments/uncertainty_distillation/train_augmented_student.py \
            ...
            --m 5 \
            --k 10 \
            --output_dir out/bert_student_augmented \
